var music = function(button, url) {
    // $('body').prepend(`
    //    <audio id="id-BGM" src=${url} autoplay="autoplay" controls="controls"></audio>`)
    // 添加 BGM
...
// 当音乐开始播放 设置滚动条最大长度 和 最大时间 和 歌曲信息
...
// 音量
$("#id-BGM-range").on('change', function(e) {
...
$(mList).each(function(i, e) {
        ...
        var temp = `<music data-id=${e.id} data-src=${src} >${name}</music>`
